      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {mode === 'login' && (
            <>
              <div>
                ...
                <input type="text" required className="input-field" placeholder="가입 시 등록한 이름"
                  value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
              </div>
              <div>
                <label className="text-sm font-medium text-[#333] mb-1.5 block">비밀번호 *</label>
                <input type="password" required minLength={4} className="input-field" placeholder="비밀번호를 입력하세요"
          ...
          {mode === 'register' && (
            <>
              ...
              <div>
                ...
                <input type="text" className="input-field" placeholder="예: 교회 소개, 지인 추천"
          ...
          {mode === 'reset' && (
            <div>
              <label className="text-sm font-medium text-[#333] mb-1.5 block">연락처 *</label>
              <input type="tel" required className="input-field" placeholder="가입 시 등록한 연락처"
                value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} />
            </div>
          )}
